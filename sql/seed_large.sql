...
--   sqlite3 data/main_V2.db ".read sql/schemas.sql" ".read sql/seed_large.sql"
...
-- Create a temporary staging table matching recordslarge.csv header order
...
.mode csv
.headers on
.import data/recordslarge.csv temp_records
